...
// ---------------------------------------------------------------------------
// (c) Traffic and AI-citation referrers
// ---------------------------------------------------------------------------
...
function manualChecksSection(): string {
  return [
    ...
    "",
    "- [Google Search Console](https://search.google.com/search-console): check Performance and Pages reports for indexing status.",
...
async function main(): Promise<void> {
  ...
  process.stdout.write([title, freshness, health, traffic, manual].join("\n"));
}
